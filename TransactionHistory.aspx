<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionHistory.aspx.cs" Inherits="BasicBankingSystemWeb_TSF_.TransactionHistory" %>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item py-3">
                        <a class="nav-link" href="TransferMoney.aspx">Transfer Money</a>
                    </li>
                    <li class="nav-item py-3">
                        <a class="nav-link active" aria-current="page" href="TransactionHistory.aspx"><strong>Transaction History</strong></a>
                    </li>
                    <li class="nav-item py-3">
    ...
    <form id="form1" runat="server">
        <br />
            <div class="row">
                ...
                <div class="col-sm-8">
                    <asp:GridView ID="TransactionHistoryGridView" runat="server" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanged="TransactionHistoryGridView_SelectedIndexChanged" Font-Bold="True" GridLines="None" Width="885px">
